...
function Heero() {
  return (
    ...
    <div class="container mx-auto flex md:px-24 md:py-32  md:flex-row flex-col items-center">
        <div
            ...
            <h1
                class="font-extrabold text-transparent text-7xl bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">
