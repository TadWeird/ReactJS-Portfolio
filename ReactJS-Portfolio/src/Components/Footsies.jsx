    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-plopnpurple-300 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/themesberg/flowbite" class="hover:text-white transition-colors duration-200">Github</a>
                      </li>
                      <li class ="mb-4">
                          <a href="https://discord.gg/4eeurUVvTy" class="hover:text-white transition-colors duration-200">Discord</a>
                      </li>
                      <li class ="mb-4">
                          <a href="#" class="hover:text-white transition-colors duration-200">GMail</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" class="text-plopnpurple-300 hover:text-white dark:hover:text-white ms-5 transition-colors duration-200">
