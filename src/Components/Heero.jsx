  ...
  return (
    ...
    <div class="container mx-auto flex md:px-24 md:py-24  md:flex-row flex-col items-center">
        <div
            ...
            <h1 class="pt-24 font-extrabold text-transparent text-7xl bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">
            ...
            <p class="mb-8 md:pl-0 text-3xl pl-2 pr-2 leading-relaxed text-gray-500">
